...
casos = np.array ([i for i in range(0,cantidad_lanzamientos)])
...
plt.xlabel("cantidad de lanzaientos antes del acierto")
plt.ylabel("destribucion de probabilidad")
plt.show()
...
for i in range (len(fr_acumulada)):
    ...
    print("distribucion de probabilidad acumulada",f_relativa)
